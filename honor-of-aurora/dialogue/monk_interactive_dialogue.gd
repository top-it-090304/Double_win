...
func _build_monk_story_5() -> void:
	...
	lines.append(_plain("healer", "Каждую минуту. Она пишет, что ждёт. На большой земле, в деревне без названия. Второе письмо пришло: «Папа. Приезжай не в латах героя. Приезжай как человек»."))
	lines.append(_plain("healer", "Ты понимаешь? Она просит меня быть собой. А я забыл, кто я без клятвы и рукава с заплатками."))
