	...
	lines.append(_choice("healer", "Теперь ты знаешь всё. И про корону, и про меня. Что ты выберешь?", [
		{
			...
			"continuation": [
				...
				["healer", "…Спасибо. Не за меч. За честность. Иди. Вернёшься — я буду у огня. Как всегда."],
			],
		},
		{
			...
			"continuation": [
				...
				["healer", "…Я знал, что ты можешь так ответить. Готовился к этому каждую ночь. Не получилось подготовиться. Иди, странник. Я… посижу у огня. Мне нужно написать письмо."],
			],
		},
	]))
