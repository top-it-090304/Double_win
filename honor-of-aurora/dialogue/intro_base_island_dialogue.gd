...
func _ensure_lines() -> void:
	...
	arr.append(_line("healer", "Ты на базе экспедиции у архипелага Аврора. Корабль ушёл, впереди — туман, причал с лодками на острова."))
	...
	arr.append(_line("healer", "Брат ордена. Меня оставили для раненых. Вокруг — твари, люди держатся у стен."))
