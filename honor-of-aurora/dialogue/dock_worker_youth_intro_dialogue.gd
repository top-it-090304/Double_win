...
func ensure_lines_ready() -> void:
	...
	lines.append(_plain("young_worker", "Мирон. Меня зовут Мирон. Я — доброволец, записался сам, когда корона вывесила объявление в порту. Все смеялись, что я мелкий. А я всё равно приплыл."))
