...
const _PRESETS: Array[Dictionary] = [
	{
		...
		KEY_DESCRIPTION: "Сюжетный режим без серьёзных трудностей: враги слабые и бьют мягко; 6 привалов за поход и привал лечит вдвое; броня почти не изнашивается; цены на услуги и приказы Короны вдвое мягче; шахта и лимиты добычи щедрые; немилость Короны почти не давит на кошелёк, одобрение хорошо помогает. На «Лёгком» включается авто-цель ближайшего врага и подсказки после повторных смертей.",
		KEY_ENEMY_STAT_MULT: 0.55,
		KEY_GOLD_REWARD_MULT: 1.5,
		KEY_EXP_REWARD_MULT: 1.5,
		KEY_EXP_TO_NEXT_LEVEL_MULT: 0.55,
		KEY_ECONOMY_COST_MULT: 0.65,
		KEY_VS_HIGHER_ENEMY_DAMAGE_MULT: 2.0,
		KEY_REST_MAX_PER_EXPEDITION: 6,
		KEY_ARMOR_WEAR_MULT: 0.15,
		KEY_SERVICE_COST_MULT: 0.55,
		KEY_CROWN_ORE_REQUIRED_MULT: 0.5,
		KEY_ENEMY_DAMAGE_TO_PLAYER_MULT: 0.45,
		KEY_REST_HEAL_RATIO_MULT: 2.0,
		KEY_MINE_YIELD_MULT: 1.6,
		KEY_EXPEDITION_CARRY_CAP_MULT: 2.0,
		KEY_SUPPLY_EFFECT_MULT: 1.3,
		KEY_CROWN_WALLET_PENALTY_STRENGTH: 0.35,
		KEY_CROWN_WALLET_FAVOR_STRENGTH: 1.5,
		KEY_ARCHER_DAMAGE_MULT: 1.3,
		KEY_ENEMY_HP_GLOBAL_MULT: 0.7,
	},
	{
		KEY_ID: Id.NORMAL,
		KEY_KEY: "normal",
